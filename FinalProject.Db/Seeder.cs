...
namespace FinalProject.Db
{
	public static class Seeder
	{
		public static void Seed(ApplicationDbContext db)
		{
            ...
            {
                new ApplicationUser() { UserName="Admin", FirstName="Admin"},
                new ApplicationUser() { UserName="JohnDoe", FirstName="John"},
                new ApplicationUser() { UserName="JaneDoe", FirstName="Jane"},
            };
